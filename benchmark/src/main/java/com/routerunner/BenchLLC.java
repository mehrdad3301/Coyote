        ...
        public void initState(BenchmarkParams params) throws Exception {
            switch (city) {
                case "baden-wuerttemberg" ->
                        graph = Graph.buildFromOSM("benchmark/src/main/resources/baden-wuerttemberg.osm");
                case "saarland" -> graph = Graph.buildFromOSM("benchmark/src/main/resources/saarland.osm");
            }
        }
    }

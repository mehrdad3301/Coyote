...
public class MapServer {
  ...
  private String getVisitedPoints() {
    StringBuilder points = new StringBuilder("[");
    for (int i : dijkstra.getVisitedNodeIds()) {
  ...
  private JSONObject getResponse(Point[] points, boolean debug) {
    ...
    if (debug) {
      json.put("points", getVisitedPoints());
    }
    return json ;
  }
